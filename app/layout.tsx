  ...
  return (
    <html lang="pt-BR">
      <body className={`font-sans ${GeistSans.variable} ${GeistMono.variable}`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-3c4f961c-1895-450a-900b-576246810b74" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_sBIO4hroo7K?ref=MA0RCL"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-3c4f961c-1895-450a-900b-576246810b74').style.display='none'"
